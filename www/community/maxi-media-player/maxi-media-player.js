 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */,{is:a,defineProperty:l,getOwnPropertyDescriptor:c,getOwnPropertyNames:d,getOwnPropertySymbols:h,getPrototypeOf:E}=Object,g=globalThis,B=g.trustedTypes,Q=B?B.emptyScript:"",u=g.reactiveElementPolyfillSupport,m=(e,t)=>e,p={toAttribute(e,t){switch(t){case Boolean:e=e?Q:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let A=e;switch(t){case Boolean:A=null!==e;break;case Number:A=null===e?null:Number(e);break;case Object:case Array:try{A=JSON.parse(e)}catch(e){A=null}}return A}},v=(e,t)=>!a(e,t),f={attribute:!0,type:String,converter:p,reflect:!1,hasChanged:v};Symbol.metadata??=Symbol("metadata"),g.litPropertyMetadata??=new WeakMap;class C extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=f){if(t.state&&(t.attribute=!1),this._$Ei(),this.elementProperties.set(e,t),!t.noAccessor){const A=Symbol(),i=this.getPropertyDescriptor(e,A,t);void 0!==i&&l(this.prototype,e,i)}}static getPropertyDescriptor(e,t,A){const{get:i,set:s}=c(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get(){return i?.call(this)},set(t){const r=i?.call(this);s.call(this,t),this.requestUpdate(e,r,A)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??f}static _$Ei(){if(this.hasOwnProperty(m("elementProperties")))return;const e=E(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(m("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(m("properties"))){const e=this.properties,t=[...d(e),...h(e)];for(const A of t)this.createProperty(A,e[A])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,A]of t)this.elementProperties.set(e,A)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const A=this._$Eu(e,t);void 0!==A&&this._$Eh.set(A,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const A=new Set(e.flat(1/0).reverse());for(const e of A)t.unshift(n(e))}else void 0!==e&&t.push(n(e));return t}static _$Eu(e,t){const A=t.attribute;return!1===A?void 0:"string"==typeof A?A:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise((e=>this.enableUpdating=e)),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach((e=>e(this)))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const A of t.keys())this.hasOwnProperty(A)&&(e.set(A,this[A]),delete this[A]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((e,i)=>{if(A)e.adoptedStyleSheets=i.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const A of i){const i=document.createElement("style"),s=t.litNonce;void 0!==s&&i.setAttribute("nonce",s),i.textContent=A.cssText,e.appendChild(i)}})(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach((e=>e.hostConnected?.()))}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach((e=>e.hostDisconnected?.()))}attributeChangedCallback(e,t,A){this._$AK(e,A)}_$EC(e,t){const A=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,A);if(void 0!==i&&!0===A.reflect){const s=(void 0!==A.converter?.toAttribute?A.converter:p).toAttribute(t,A.type);this._$Em=e,null==s?this.removeAttribute(i):this.setAttribute(i,s),this._$Em=null}}_$AK(e,t){const A=this.constructor,i=A._$Eh.get(e);if(void 0!==i&&this._$Em!==i){const e=A.getPropertyOptions(i),s="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:p;this._$Em=i,this[i]=s.fromAttribute(t,e.type),this._$Em=null}}requestUpdate(e,t,A){if(void 0!==e){if(A??=this.constructor.getPropertyOptions(e),!(A.hasChanged??v)(this[e],t))return;this.P(e,t,A)}!1===this.isUpdatePending&&(this._$ES=this._$ET())}P(e,t,A){this._$AL.has(e)||this._$AL.set(e,t),!0===A.reflect&&this._$Em!==e&&(this._$Ej??=new Set).add(e)}async _$ET(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,A]of e)!0!==A.wrapped||this._$AL.has(t)||void 0===this[t]||this.P(t,this[t],A)}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach((e=>e.hostUpdate?.())),this.update(t)):this._$EU()}catch(t){throw e=!1,this._$EU(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach((e=>e.hostUpdated?.())),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EU(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Ej&&=this._$Ej.forEach((e=>this._$EC(e,this[e]))),this._$EU()}updated(e){}firstUpdated(e){}}C.elementStyles=[],C.shadowRootOptions={mode:"open"},C[m("elementProperties")]=new Map,C[m("finalized")]=new Map,u?.({ReactiveElement:C}),(g.reactiveElementVersions??=[]).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const y=globalThis,b=y.trustedTypes,I=b?b.createPolicy("lit-html",{createHTML:e=>e}):void 0,w="$lit$",P=`lit$${Math.random().toFixed(9).slice(2)}$`,S="?"+P,x=`<${S}>`,V=document,O=()=>V.createComment(""),L=e=>null===e||"object"!=typeof e&&"function"!=typeof e,M=Array.isArray,k="[ \t\n\f\r]",H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,z=/-->/g,N=/>/g,T=RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),U=/'/g,X=/"/g,R=/^(?:script|style|textarea|title)$/i,j=(e=>(t,...A)=>({_$litType$:e,strings:t,values:A}))(1),G=Symbol.for("lit-noChange"),W=Symbol.for("lit-nothing"),D=new WeakMap,q=V.createTreeWalker(V,129);function Z(e,t){if(!M(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==I?I.createHTML(t):t}class Y{constructor({strings:e,_$litType$:t},A){let i;this.parts=[];let s=0,r=0;const o=e.length-1,n=this.parts,[a,l]=((e,t)=>{const A=e.length-1,i=[];let s,r=2===t?"<svg>":3===t?"<math>":"",o=H;for(let t=0;t<A;t++){const A=e[t];let n,a,l=-1,c=0;for(;c<A.length&&(o.lastIndex=c,a=o.exec(A),null!==a);)c=o.lastIndex,o===H?"!--"===a[1]?o=z:void 0!==a[1]?o=N:void 0!==a[2]?(R.test(a[2])&&(s=RegExp("</"+a[2],"g")),o=T):void 0!==a[3]&&(o=T):o===T?">"===a[0]?(o=s??H,l=-1):void 0===a[1]?l=-2:(l=o.lastIndex-a[2].length,n=a[1],o=void 0===a[3]?T:'"'===a[3]?X:U):o===X||o===U?o=T:o===z||o===N?o=H:(o=T,s=void 0);const d=o===T&&e[t+1].startsWith("/>")?" ":"";r+=o===H?A+x:l>=0?(i.push(n),A.slice(0,l)+w+A.slice(l)+P+d):A+P+(-2===l?t:d)}return[Z(e,r+(e[A]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),i]})(e,t);if(this.el=Y.createElement(a,A),q.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(i=q.nextNode())&&n.length<o;){if(1===i.nodeType){if(i.hasAttributes())for(const e of i.getAttributeNames())if(e.endsWith(w)){const t=l[r++],A=i.getAttribute(e).split(P),o=/([.?@])?(.*)/.exec(t);n.push({type:1,index:s,name:o[2],strings:A,ctor:"."===o[1]?_:"?"===o[1]?ee:"@"===o[1]?te:$}),i.removeAttribute(e)}else e.startsWith(P)&&(n.push({type:6,index:s}),i.removeAttribute(e));if(R.test(i.tagName)){const e=i.textContent.split(P),t=e.length-1;if(t>0){i.textContent=b?b.emptyScript:"";for(let A=0;A<t;A++)i.append(e[A],O()),q.nextNode(),n.push({type:2,index:++s});i.append(e[t],O())}}}else if(8===i.nodeType)if(i.data===S)n.push({type:2,index:s});else{let e=-1;for(;-1!==(e=i.data.indexOf(P,e+1));)n.push({type:7,index:s}),e+=P.length-1}s++}}static createElement(e,t){const A=V.createElement("template");return A.innerHTML=e,A}}function J(e,t,A=e,i){if(t===G)return t;let s=void 0!==i?A.o?.[i]:A.l;const r=L(t)?void 0:t._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),void 0===r?s=void 0:(s=new r(e),s._$AT(e,A,i)),void 0!==i?(A.o??=[])[i]=s:A.l=s),void 0!==s&&(t=J(e,s._$AS(e,t.values),s,i)),t}class F{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:A}=this._$AD,i=(e?.creationScope??V).importNode(t,!0);q.currentNode=i;let s=q.nextNode(),r=0,o=0,n=A[0];for(;void 0!==n;){if(r===n.index){let t;2===n.type?t=new K(s,s.nextSibling,this,e):1===n.type?t=new n.ctor(s,n.name,n.strings,this,e):6===n.type&&(t=new Ae(s,this,e)),this._$AV.push(t),n=A[++o]}r!==n?.index&&(s=q.nextNode(),r++)}return q.currentNode=V,i}p(e){let t=0;for(const A of this._$AV)void 0!==A&&(void 0!==A.strings?(A._$AI(e,A,t),t+=A.strings.length-2):A._$AI(e[t])),t++}}class K{get _$AU(){return this._$AM?._$AU??this.v}constructor(e,t,A,i){this.type=2,this._$AH=W,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=A,this.options=i,this.v=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=J(this,e,t),L(e)?e===W||null==e||""===e?(this._$AH!==W&&this._$AR(),this._$AH=W):e!==this._$AH&&e!==G&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>M(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==W&&L(this._$AH)?this._$AA.nextSibling.data=e:this.T(V.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:A}=e,i="number"==typeof A?this._$AC(e):(void 0===A.el&&(A.el=Y.createElement(Z(A.h,A.h[0]),this.options)),A);if(this._$AH?._$AD===i)this._$AH.p(t);else{const e=new F(i,this),A=e.u(this.options);e.p(t),this.T(A),this._$AH=e}}_$AC(e){let t=D.get(e.strings);return void 0===t&&D.set(e.strings,t=new Y(e)),t}k(e){M(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let A,i=0;for(const s of e)i===t.length?t.push(A=new K(this.O(O()),this.O(O()),this,this.options)):A=t[i],A._$AI(s),i++;i<t.length&&(this._$AR(A&&A._$AB.nextSibling,i),t.length=i)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){void 0===this._$AM&&(this.v=e,this._$AP?.(e))}}class ${get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,A,i,s){this.type=1,this._$AH=W,this._$AN=void 0,this.element=e,this.name=t,this._$AM=i,this.options=s,A.length>2||""!==A[0]||""!==A[1]?(this._$AH=Array(A.length-1).fill(new String),this.strings=A):this._$AH=W}_$AI(e,t=this,A,i){const s=this.strings;let r=!1;if(void 0===s)e=J(this,e,t,0),r=!L(e)||e!==this._$AH&&e!==G,r&&(this._$AH=e);else{const i=e;let o,n;for(e=s[0],o=0;o<s.length-1;o++)n=J(this,i[A+o],t,o),n===G&&(n=this._$AH[o]),r||=!L(n)||n!==this._$AH[o],n===W?e=W:e!==W&&(e+=(n??"")+s[o+1]),this._$AH[o]=n}r&&!i&&this.j(e)}j(e){e===W?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class _ extends ${constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===W?void 0:e}}class ee extends ${constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==W)}}class te extends ${constructor(e,t,A,i,s){super(e,t,A,i,s),this.type=5}_$AI(e,t=this){if((e=J(this,e,t,0)??W)===G)return;const A=this._$AH,i=e===W&&A!==W||e.capture!==A.capture||e.once!==A.once||e.passive!==A.passive,s=e!==W&&(A===W||i);i&&this.element.removeEventListener(this.name,this,A),s&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Ae{constructor(e,t,A){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=A}get _$AU(){return this._$AM._$AU}_$AI(e){J(this,e)}}const ie=y.litHtmlPolyfillSupport;ie?.(Y,K),(y.litHtmlVersions??=[]).push("3.2.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
class se extends C{constructor(){super(...arguments),this.renderOptions={host:this},this.o=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.o=((e,t,A)=>{const i=A?.renderBefore??t;let s=i._$litPart$;if(void 0===s){const e=A?.renderBefore??null;i._$litPart$=s=new K(t.insertBefore(O(),e),e,void 0,A??{})}return s._$AI(e),s})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this.o?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this.o?.setConnected(!1)}render(){return G}}se._$litElement$=!0,se.finalized=!0,globalThis.litElementHydrateSupport?.({LitElement:se});const re=globalThis.litElementPolyfillSupport;re?.({LitElement:se}),(globalThis.litElementVersions??=[]).push("4.1.0");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const oe={attribute:!0,type:String,converter:p,reflect:!1,hasChanged:v},ne=(e=oe,t,A)=>{const{kind:i,metadata:s}=A;let r=globalThis.litPropertyMetadata.get(s);if(void 0===r&&globalThis.litPropertyMetadata.set(s,r=new Map),r.set(A.name,e),"accessor"===i){const{name:i}=A;return{set(A){const s=t.get.call(this);t.set.call(this,A),this.requestUpdate(i,s,e)},init(t){return void 0!==t&&this.P(i,void 0,e),t}}}if("setter"===i){const{name:i}=A;return function(A){const s=this[i];t.call(this,A),this.requestUpdate(i,s,e)}}throw Error("Unsupported decorator location: "+i)};function ae(e){return(t,A)=>"object"==typeof A?ne(e,t,A):((e,t,A)=>{const i=t.hasOwnProperty(A);return t.constructor.createProperty(A,i?{...e,wrapped:!0}:e),i?Object.getOwnPropertyDescriptor(t,A):void 0})(e,t,A)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */}function le(e){return ae({...e,state:!0,attribute:!1})}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ce=(e,t,A)=>(A.configurable=!0,A.enumerable=!0,Reflect.decorate&&"object"!=typeof t&&Object.defineProperty(e,t,A),A)
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */;var de,he;!function(e){e.MEDIA_BROWSER="media browser",e.GROUPS="groups",e.PLAYER="player",e.GROUPING="grouping",e.VOLUMES="volumes"}(de||(de={})),function(e){e[e.PAUSE=1]="PAUSE",e[e.SEEK=2]="SEEK",e[e.VOLUME_SET=4]="VOLUME_SET",e[e.VOLUME_MUTE=8]="VOLUME_MUTE",e[e.PREVIOUS_TRACK=16]="PREVIOUS_TRACK",e[e.NEXT_TRACK=32]="NEXT_TRACK",e[e.TURN_ON=128]="TURN_ON",e[e.TURN_OFF=256]="TURN_OFF",e[e.PLAY_MEDIA=512]="PLAY_MEDIA",e[e.VOLUME_BUTTONS=1024]="VOLUME_BUTTONS",e[e.SELECT_SOURCE=2048]="SELECT_SOURCE",e[e.STOP=4096]="STOP",e[e.CLEAR_PLAYLIST=8192]="CLEAR_PLAYLIST",e[e.PLAY=16384]="PLAY",e[e.SHUFFLE_SET=32768]="SHUFFLE_SET",e[e.SELECT_SOUND_MODE=65536]="SELECT_SOUND_MODE",e[e.BROWSE_MEDIA=131072]="BROWSE_MEDIA",e[e.REPEAT_SET=262144]="REPEAT_SET",e[e.GROUPING=524288]="GROUPING"}(he||(he={}));var Ee="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z",ge="M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z",Be="M20.71,7.04C20.37,7.38 20.04,7.71 20.03,8.04C20,8.36 20.34,8.69 20.66,9C21.14,9.5 21.61,9.95 21.59,10.44C21.57,10.93 21.06,11.44 20.55,11.94L16.42,16.08L15,14.66L19.25,10.42L18.29,9.46L16.87,10.87L13.12,7.12L16.96,3.29C17.35,2.9 18,2.9 18.37,3.29L20.71,5.63C21.1,6 21.1,6.65 20.71,7.04M3,17.25L12.56,7.68L16.31,11.43L6.75,21H3V17.25Z",Qe="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",ue="M3,9H7L12,4V20L7,15H3V9M14,11H22V13H14V11Z",me="M3,9H7L12,4V20L7,15H3V9M14,11H17V8H19V11H22V13H19V16H17V13H14V11Z";
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const pe=1,ve=2,fe=e=>(...t)=>({_$litDirective$:e,values:t});
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ce{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,A){this.t=e,this._$AM=t,this.i=A}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ye=(e,t)=>{const A=e._$AN;if(void 0===A)return!1;for(const e of A)e._$AO?.(t,!1),ye(e,t);return!0},be=e=>{let t,A;do{if(void 0===(t=e._$AM))break;A=t._$AN,A.delete(e),e=t}while(0===A?.size)},Ie=e=>{for(let t;t=e._$AM;e=t){let A=t._$AN;if(void 0===A)t._$AN=A=new Set;else if(A.has(e))break;A.add(e),Se(t)}};function we(e){void 0!==this._$AN?(be(this),this._$AM=e,Ie(this)):this._$AM=e}function Pe(e,t=!1,A=0){const i=this._$AH,s=this._$AN;if(void 0!==s&&0!==s.size)if(t)if(Array.isArray(i))for(let e=A;e<i.length;e++)ye(i[e],!1),be(i[e]);else null!=i&&(ye(i,!1),be(i));else ye(this,e)}const Se=e=>{e.type==ve&&(e._$AP??=Pe,e._$AQ??=we)};class xe extends Ce{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,t,A){super._$AT(e,t,A),Ie(this),this.isConnected=e._$AU}_$AO(e,t=!0){e!==this.isConnected&&(this.isConnected=e,e?this.reconnected?.():this.disconnected?.()),t&&(ye(this,e),be(this))}setValue(e){if((e=>void 0===e.strings)(this.t))this.t._$AI(e,this);else{const t=[...this.t._$AH];t[this.i]=e,this.t._$AI(t,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ve{constructor(e){this.Y=e}disconnect(){this.Y=void 0}reconnect(e){this.Y=e}deref(){return this.Y}}class Oe{constructor(){this.Z=void 0,this.q=void 0}get(){return this.Z}pause(){this.Z??=new Promise((e=>this.q=e))}resume(){this.q?.(),this.Z=this.q=void 0}}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Le=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,Me=1073741823;const ke=fe(class extends xe{constructor(){super(...arguments),this.wt=Me,this.bt=[],this.K=new Ve(this),this.X=new Oe}render(...e){return e.find((e=>!Le(e)))??G}update(e,t){const A=this.bt;let i=A.length;this.bt=t;const s=this.K,r=this.X;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this.wt);e++){const o=t[e];if(!Le(o))return this.wt=e,o;e<i&&o===A[e]||(this.wt=Me,i=0,Promise.resolve(o).then((async e=>{for(;r.get();)await r.get();const t=s.deref();if(void 0!==t){const A=t.bt.indexOf(o);A>-1&&A<t.wt&&(t.wt=A,t.setValue(e))}})))}return G}disconnected(){this.K.disconnect(),this.X.pause()}reconnected(){this.K.reconnect(this),this.X.resume()}}),{SHUFFLE_SET:He,REPEAT_SET:ze,PLAY:Ne,PAUSE:Te,NEXT_TRACK:Ue,PREVIOUS_TRACK:Xe}=he;class Re extends se{constructor(){super(...arguments),this.volDown=async()=>await this.mediaControlService.volumeDown(this.volumePlayer,!this.config.playerVolumeEntityId),this.volUp=async()=>await this.mediaControlService.volumeUp(this.volumePlayer,!this.config.playerVolumeEntityId)}render(){var e;this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService,this.volumePlayer=null!==(e=this.activePlayer.getMember(this.config.playerVolumeEntityId))&&void 0!==e?e:this.activePlayer;const t=!!this.config.showVolumeUpAndDownButtons&&W;return j`
      <div class="main" id="mediaControls">
          <div class="icons">
              <div class="flex-1"></div>
              <ha-icon-button hide=${t} @click=${this.volDown} .path=${ue}></ha-icon-button>
              ...
              <mxmp-ha-player .store=${this.store} .features=${[Ne,Te]} class="big-icon"></mxmp-ha-player>
              ...
              <div class="audio-input-format">
                  ${this.config.showAudioInputFormat&&ke(this.getAudioInputFormat())}
              </div>
          </div>
          <mxmp-volume .store=${this.store} .player=${this.volumePlayer}
                       .updateMembers=${!this.config.playerVolumeEntityId}></mxmp-volume>
          <div class="icons">
              <mxmp-ha-player .store=${this.store} .features=${this.store.showPower(!0)}></mxmp-ha-player>
          </div">
      </div>
  `}async getAudioInputFormat(){const e=(await this.store.hassService.getRelatedEntities(this.activePlayer,"sensor")).find((e=>e.entity_id.includes("audio_input_format")));return e&&e.state&&"No audio"!==e.state?j`<div>${e.state}</div>`:""}showShuffle(){return this.config.hidePlayerControlShuffleButton?[]:[He]}showPrev(){return this.config.hidePlayerControlPrevTrackButton?[]:[Xe]}showNext(){return this.config.hidePlayerControlNextTrackButton?[]:[Ue]}showRepeat(){return this.config.hidePlayerControlRepeatButton?[]:[ze]}static get styles(){return o`
      .main {
    ...
    `}}e([ae({attribute:!1})],Re.prototype,"store",void 0),customElements.define("mxmp-player-controls",Re);const je="mxmp-dispatch-event-",Ge="active-player",We=je+Ge,De=je+"call-media-started",qe=je+"call-media-done",Ze="item-selected",Ye=o`
  .list {
...
`,{TURN_ON:Fe}=he;function Ke(e,t=[]){const A=e.members.map((e=>e.id)).sort();if(null==t?void 0:t.length){const e=t.find((e=>e.entities.map((e=>e.player.id)).sort().toString()===A.toString()));if(e)return e.name}return e.members.map((e=>e.name)).join(" + ")}function $e(e,t,A){_e(t)?function(e,t){const A=et(e,t);window.dispatchEvent(A)}(We,{entityId:e}):A.dispatchEvent(et(Ge,{entityId:e}))}function _e(e){return e.sections&&e.sections.length<Object.keys(de).length}function et(e,t){return new CustomEvent(e,{bubbles:!0,composed:!0,detail:t})}const tt=40;function At(e){return e?e/100*tt:tt}function it(e){return e.attributes.group_members||[e.entity_id]}class st extends se{render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer;const e=Ke(this.activePlayer,this.store.predefinedGroups);let t=this.activePlayer.getCurrentTrack();return t=t||this.config.labelWhenNoMediaIsSelected||"No media selected",this.config.showSourceInPlayer&&this.activePlayer.attributes.source&&(t=`${t} (${this.activePlayer.attributes.source})`),j` <div class="info">
    ...
    `}}e([ae({attribute:!1})],st.prototype,"store",void 0),customElements.define("mxmp-player-header",st);
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const rt="important",ot=" !"+rt,nt=fe(class extends Ce{constructor(e){if(super(e),e.type!==pe||"style"!==e.name||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,A)=>{const i=e[A];return null==i?t:t+`${A=A.includes("-")?A:A.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${i};`}),"")}update(e,[t]){const{style:A}=e.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(t)),this.render(t);for(const e of this.ft)null==t[e]&&(this.ft.delete(e),e.includes("-")?A.removeProperty(e):A[e]=null);for(const e in t){const i=t[e];if(null!=i){this.ft.add(e);const t="string"==typeof i&&i.endsWith(ot);e.includes("-")||t?A.setProperty(e,t?i.slice(0,-11):i,t?rt:""):A[e]=i}}return G}});class at extends se{constructor(){super(...arguments),this.mediaDuration=0}disconnectedCallback(){this.tracker&&(clearInterval(this.tracker),this.tracker=void 0),super.disconnectedCallback()}render(){var e;this.activePlayer=this.store.activePlayer,this.mediaDuration=(null===(e=this.activePlayer)||void 0===e?void 0:e.attributes.media_duration)||0;return this.mediaDuration>0?(this.trackProgress(),j`
        <div class="progress">
          <span>${lt(this.playingProgress)}</span>
          <div class="bar" @click=${this.handleSeek}>
            <div class="progress-bar" style=${this.progressBarStyle(this.mediaDuration)}></div>
          </div>
          <span> -${lt(this.mediaDuration-this.playingProgress)}</span>
        </div>
      `):j``}async handleSeek(e){const t=this.progressBar.offsetWidth,A=e.offsetX/t,i=this.mediaDuration*A;await this.store.mediaControlService.seek(this.activePlayer,i)}progressBarStyle(e){return nt({width:this.playingProgress/e*100+"%"})}trackProgress(){var e,t,A;const i=(null===(e=this.activePlayer)||void 0===e?void 0:e.attributes.media_position)||0,s=null===(t=this.activePlayer)||void 0===t?void 0:t.isPlaying(),r=(null===(A=this.activePlayer)||void 0===A?void 0:A.attributes.media_position_updated_at)||0;this.playingProgress=s?i+(Date.now()-new Date(r).getTime())/1e3:i,this.tracker||(this.tracker=setInterval((()=>this.trackProgress()),1e3)),s||(clearInterval(this.tracker),this.tracker=void 0)}static get styles(){return o`
      .progress {
        width: 100%;
        font-size: x-small;
        display: flex;
    ...
    `}}e([ae({attribute:!1})],at.prototype,"store",void 0),e([le()],at.prototype,"playingProgress",void 0),e([function(e,t){return(A,i,s)=>{const r=t=>t.renderRoot?.querySelector(e)??null;if(t){const{get:e,set:t}="object"==typeof i?A:s??(()=>{const e=Symbol();return{get(){return this[e]},set(t){this[e]=t}}})();return ce(A,i,{get(){let A=e.call(this);return void 0===A&&(A=r(this),(null!==A||this.hasUpdated)&&t.call(this,A)),A}})}return ce(A,i,{get(){return r(this)}})}}(".bar")],at.prototype,"progressBar",void 0);const lt=e=>{const t=new Date(1e3*e).toISOString().substring(11,19);return t.startsWith("00:")?t.substring(3):t};customElements.define("mxmp-progress",at);class ct extends se{constructor(){super(...arguments),this.updateMembers=!0,this.slim=!1}render(){this.config=this.store.config,this.mediaControlService=this.store.mediaControlService;const e=this.player.getVolume(),t=this.getMax(e),A=this.player.isMuted(this.updateMembers)?"M3,9H7L12,4V20L7,15H3V9M16.59,12L14,9.41L15.41,8L18,10.59L20.59,8L22,9.41L19.41,12L22,14.59L20.59,16L18,13.41L15.41,16L14,14.59L16.59,12Z":"M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3,9V15H7L12,20V4L7,9H3Z",i=this.player.ignoreVolume;return j`
      <div class="volume" slim=${this.slim||W}>
        ...
        <div class="volume-slider">
          ...
          <div class="volume-level">
            ...
            <div class="percentage">${Math.round(e)}%</div>
            <div style="flex: ${t-e};text-align: right">${t}%</div>
          </div>
        </div>
        <mxmp-ha-player .store=${this.store} .features=${this.store.showPower()}></mxmp-ha-player>
      </div>
    `}getMax(e){var t,A;const i=Math.max(0,Math.min(null!==(t=this.config.dynamicVolumeSliderThreshold)&&void 0!==t?t:20,100)),s=Math.max(0,Math.min(null!==(A=this.config.dynamicVolumeSliderMax)&&void 0!==A?A:30,100));return e<i&&this.config.dynamicVolumeSlider?s:100}async volumeChanged(e){const t=function(e){var t;return Number.parseInt(null===(t=null==e?void 0:e.target)||void 0===t?void 0:t.value)}(e);return await this.mediaControlService.volumeSet(this.player,t,this.updateMembers)}async mute(){return await this.mediaControlService.toggleMute(this.player,this.updateMembers)}static get styles(){return o`
      ha-control-slider {
    ...
    `}}e([ae({attribute:!1})],ct.prototype,"store",void 0),e([ae({attribute:!1})],ct.prototype,"player",void 0),e([ae({type:Boolean})],ct.prototype,"updateMembers",void 0),e([ae()],ct.prototype,"volumeClicked",void 0),e([ae()],ct.prototype,"slim",void 0),customElements.define("mxmp-volume",ct);class dt extends se{render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer;const e=this.config.artworkAsBackground;return j`
...
const ht=(e,t,A)=>{for(const A of t)if(A[0]===e)return(0,A[1])();return A?.()};class Et{constructor(e,t,A,i){this.hass=e,this.currentSection=t,this.card=A,this.config=i}async callMediaService(e,t){this.card.dispatchEvent(et(De,{section:this.currentSection}));try{await this.hass.callService("media_player",e,t)}finally{this.card.dispatchEvent(et(qe))}}async browseMedia(e,t,A){var i;const s=await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:A,media_content_type:t});return this.config.replaceHttpWithHttpsForThumbnails&&(s.children=null===(i=s.children)||void 0===i?void 0:i.map((e=>{var t;return Object.assign(Object.assign({},e),{thumbnail:null===(t=e.thumbnail)||void 0===t?void 0:t.replace("http://","https://")})}))),s}async getRelatedEntities(e,...t){return new Promise((async(A,i)=>{const s={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((i=>{e(),A(i.result.filter((e=>t.some((t=>e.includes(t))))).map((e=>this.hass.states[e])))}),s)}catch(e){i(e)}}))}}const gt="data:image/png;base64,";function Bt(e,t){for(const A in e)if(Qt(A)===Qt(t))return e[A]}function Qt(e){return e.replace(/[^a-zA-Z ]/g,"")}function ut(e,t){let A=-1;return e.forEach(((e,i)=>{Qt(e)===Qt(t)&&(A=i)})),A}function mt(e,t){const A=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,t,A){var i,s;let r=null!==(i=Bt(t.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return r?(null==r?void 0:r.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(r=null==r?void 0:r.replace("logo.png","icon.png")):(r=Bt(t.customThumbnailIfMissing,e.title),A&&!r&&(r=(null===(s=t.customThumbnailIfMissing)||void 0===s?void 0:s.default)||gt)),r||""}(e,t,A);return Object.assign(Object.assign({},e),{thumbnail:i})}))}function pt(e,t){return j`
  ...
  `}class ft{constructor(e,t){this.hassService=e,this.config=t}async getFavorites(e){if(!e)return[];let t=await this.getFavoritesForPlayer(e);return t=t.flatMap((e=>e)),t=this.removeDuplicates(t),t=t.length?t:this.getFavoritesFromStates(e),t.filter((e=>{var t;return-1===ut(null!==(t=this.config.favoritesToIgnore)&&void 0!==t?t:[],e.title)}))}removeDuplicates(e){return e.filter(((e,t,A)=>t===A.findIndex((t=>t.title===e.title))))}async getFavoritesForPlayer(e){var t;try{const A=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((t=>this.hassService.browseMedia(e,t.media_content_type,t.media_content_id)));return(A?await Promise.all(A):[]).flatMap((e=>{var t;return null!==(t=e.children)&&void 0!==t?t:[]}))}catch(t){return console.log("Maxi Media Player: error getting favorites for player "+e.id+": "+JSON.stringify(t)),[]}}getFavoritesFromStates(e){return(e.attributes.hasOwnProperty("source_list")?e.attributes.source_list:[]).map((e=>({title:e})))}}class Ct{constructor(e,t){this.hassService=e,this.config=t}async join(e,t){await this.hassService.callMediaService("join",{entity_id:e,group_members:t})}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async setVolumeAndMediaForPredefinedGroup(e){var t;for(const A of e.entities){const i=null!==(t=A.volume)&&void 0!==t?t:e.volume;i&&await this.volumeSetSinglePlayer(A.player,i),e.unmuteWhenGrouped&&await this.setVolumeMute(A.player,!1,!1)}e.media&&await this.setSource(e.entities[0].player,e.media)}async volumeDown(e,t=!0){await this.volumeStep(e,t,this.getStepDownVolume,"volume_down")}async volumeUp(e,t=!0){await this.volumeStep(e,t,this.getStepUpVolume,"volume_up")}async volumeStep(e,t,A,i){this.config.volumeStepSize?await this.volumeWithStepSize(e,t,this.config.volumeStepSize,A):await this.volumeDefaultStep(e,t,i)}async volumeWithStepSize(e,t,A,i){for(const s of e.members)if(e.id===s.id||t){const e=i(s,A);await this.volumeSetSinglePlayer(s,e)}}getStepDownVolume(e,t){return Math.max(0,e.getVolume()-t)}getStepUpVolume(e,t){return Math.min(100,e.getVolume()+t)}async volumeDefaultStep(e,t,A){for(const i of e.members)(e.id===i.id||t)&&(i.ignoreVolume||await this.hassService.callMediaService(A,{entity_id:i.id}))}async volumeSet(e,t,A){return A?await this.volumeSetGroup(e,t):await this.volumeSetSinglePlayer(e,t)}async volumeSetGroup(e,t){let A;this.config.adjustVolumeRelativeToMainPlayer&&(A=t/e.getVolume()),await Promise.all(e.members.map((e=>{let i=t;return void 0!==A&&this.config.adjustVolumeRelativeToMainPlayer&&(i=e.getVolume()*A,i=Math.min(100,Math.max(0,i))),this.volumeSetSinglePlayer(e,i)})))}async volumeSetSinglePlayer(e,t){if(!e.ignoreVolume){const A=t/100;await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:A})}}async toggleMute(e,t=!0){const A=!e.isMuted(t);await this.setVolumeMute(e,A,t)}async setVolumeMute(e,t,A=!0){for(const i of e.members)(e.id===i.id||A)&&await this.hassService.callMediaService("volume_mute",{entity_id:i.id,is_volume_muted:t})}async setSource(e,t){await this.hassService.callMediaService("select_source",{source:t,entity_id:e.id})}async playMedia(e,t){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}async seek(e,t){await this.hassService.callMediaService("media_seek",{entity_id:e.id,seek_position:t})}}class yt{constructor(e,t,A){var i;this.id=e.entity_id,this.config=t,this.name=this.getEntityName(e,t),this.state=e.state,this.attributes=e.attributes,this.members=A?this.createGroupMembers(e,A):[this],this.volumePlayer=this.determineVolumePlayer(),this.ignoreVolume=!!(null===(i=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===i?void 0:i.includes(this.volumePlayer.id))}getMember(e){return this.members.find((t=>t.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(e){return this.attributes.is_volume_muted&&(!e||this.members.every((e=>e.isMuted(!1))))}getCurrentTrack(){return`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`.replace(/^ - | - $/g,"")}getEntityName(e,t){const A=e.attributes.friendly_name||"";return t.entityNameRegexToReplace?A.replace(new RegExp(t.entityNameRegexToReplace,"g"),t.entityNameReplacement||""):A}createGroupMembers(e,t){const A=[];for(const i of it(e))for(const e of t)e.entity_id===i&&A.push(new yt(e,this.config));return(null==A?void 0:A.length)?A:[this]}determineVolumePlayer(){let e;return this.members.length>1&&this.config.entitiesToIgnoreVolumeLevelFor&&(e=this.members.find((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))}))),null!=e?e:this}getVolume(){return this.members.length>1&&this.config.adjustVolumeRelativeToMainPlayer?this.getAverageVolume():this.volumePlayer.attributes.volume_level?100*this.volumePlayer.attributes.volume_level:0}getAverageVolume(){const e=this.members.filter((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))})).map((e=>e.attributes.volume_level));return 100*e.reduce(((e,t)=>e+t),0)/e.length}}const{TURN_OFF:bt,TURN_ON:It}=he;class wt{constructor(e,t,A,i,s){this.hass=e,this.config=t;const r=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(r),this.allMediaPlayers=this.allGroups.reduce(((e,t)=>[...e,...t.members]),[]).sort(((e,t)=>e.name.localeCompare(t.name))),this.activePlayer=this.determineActivePlayer(s),this.hassService=new Et(this.hass,A,i,t),this.mediaControlService=new Ct(this.hassService,t),this.mediaBrowseService=new ft(this.hassService,t),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const t of this.config.predefinedGroups){const A=this.createPredefinedGroup(t);A&&e.push(A)}return e}createPredefinedGroup(e){let t;const A=[];let i=e.entities;e.excludeItemsInEntitiesList&&(i=this.convertExclusionsInPredefinedGroupsToInclusions(i));for(const e of i){const t=this.createPredefinedGroupPlayer(e);t&&A.push(t)}return A.length&&(t=Object.assign(Object.assign({},e),{entities:A})),t}convertExclusionsInPredefinedGroupsToInclusions(e){return this.allMediaPlayers.filter((t=>!e.find((e=>("string"==typeof e?e:e.player)===t.id)))).map((e=>e.id))}createPredefinedGroupPlayer(e){var t;let A,i,s;if("string"==typeof e?A=e:(i=e.volume,A=e.player),"unavailable"!==(null===(t=this.hass.states[A])||void 0===t?void 0:t.state)){const e=this.allMediaPlayers.find((e=>e.id===A));e&&(s={player:e,volume:i})}else console.warn(`Player ${A} is unavailable`);return s}getMediaPlayerHassEntities(e){const t=e,A=[...new Set(this.config.entities)];return Object.values(e.states).filter((e=>{var i,s;if(e.entity_id.includes("media_player")){if(this.config.entityPlatform){return(null===(s=null===(i=t.entities)||void 0===i?void 0:i[e.entity_id])||void 0===s?void 0:s.platform)===this.config.entityPlatform}if(A.length){const t=A.includes(e.entity_id);return!!this.config.excludeItemsInEntitiesList!==t}}return!1})).sort(((e,t)=>e.entity_id.localeCompare(t.entity_id)))}createPlayerGroups(e){return e.filter((t=>this.isMainPlayer(t,e))).map((t=>this.createPlayerGroup(t,e))).filter((e=>void 0!==e))}isMainPlayer(e,t){var A;try{const i=it(e).filter((e=>t.some((t=>t.entity_id===e)))),s=(null==i?void 0:i.length)>1,r=s&&i&&i[0]===e.entity_id,o="unavailable"!==(null===(A=this.hass.states[e.entity_id])||void 0===A?void 0:A.state);return o||console.warn(`Player ${e.entity_id} is unavailable`),(!s||r)&&o}catch(t){return console.error("Failed to determine main player",JSON.stringify(e),t),!1}}createPlayerGroup(e,t){try{return new yt(e,this.config,t)}catch(t){return void console.error("Failed to create group",JSON.stringify(e),t)}}determineActivePlayer(e){const t=e||this.config.selectedEntityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getMember(t)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.includes("#")?window.location.href.replace(/.*#/g,""):""}showPower(e=!1){return this.config.hidePlayerControlPowerButton?[]:((this.activePlayer.attributes.supported_features||0)&Fe)!=Fe||e&&"off"!==this.activePlayer.state?[]:[It,bt]}}const{GROUPING:Pt,GROUPS:St,MEDIA_BROWSER:xt,PLAYER:Vt,VOLUMES:Ot}=de;class Lt extends se{render(){return j`
      ...
      <ha-icon-button
        ...
        @click=${()=>this.dispatchSection(xt)}
        selected=${this.selected(xt)}
      ></ha-icon-button>
      <ha-icon-button
        hide=${this.hide(St)}
      ...
      ></ha-icon-button>
    `}dispatchSection(e){this.dispatchEvent(et("show-section",e))}selected(e){return this.section===e||W}hide(e){var t;return this.config.sections&&!(null===(t=this.config.sections)||void 0===t?void 0:t.includes(e))||W}static get styles(){return o`
      :host {
        display: flex;
    ...
    `}}var Mt,kt;e([ae({attribute:!1})],Lt.prototype,"config",void 0),e([ae()],Lt.prototype,"section",void 0),customElements.define("mxmp-footer",Lt),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(Mt||(Mt={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(kt||(kt={}));var Ht;class zt extends se{setConfig(e){this.config=JSON.parse(JSON.stringify(e))}static get styles(){return o`
      ha-svg-icon {
        margin: 5px;
      }
      ha-control-button {
    ...
    `}changed(e){const t=e.detail.value;this.config=Object.assign(Object.assign(Object.assign({},this.config),t),{topFavorites:t.topFavorites.split(/ *, */)}),this.configChanged()}});class Tt extends zt{render(){return j``}}e([ae({type:Number})],Tt.prototype,"index",void 0),customElements.define("mxmp-custom-source-editor",Tt);const Ut=[{type:"multi_select",options:{player:"Player","media browser":"Media Browser",groups:"Groups",grouping:"Grouping",volumes:"Volumes"},name:"sections"},{type:"integer",name:"mediaBrowserItemsPerRow",default:4,required:!0,valueMin:1,valueMax:30},{type:"string",name:"title"},{name:"showVolumeUpAndDownButtons",selector:{boolean:{}}},{name:"hidePlayerControlPowerButton",selector:{boolean:{}}},{name:"hidePlayerControlShuffleButton",selector:{boolean:{}}},{name:"hidePlayerControlPrevTrackButton",selector:{boolean:{}}},{name:"hidePlayerControlNextTrackButton",selector:{boolean:{}}},{name:"hidePlayerControlRepeatButton",selector:{boolean:{}}},{type:"integer",name:"widthPercentage",default:100,required:!0},{type:"integer",name:"heightPercentage",default:100,required:!0}];customElements.define("mxmp-general-editor",class extends zt{render(){return j`
      <mxmp-editor-form
        .schema=${Ut}
        .config=${this.config}
        .hass=${this.hass}
      ></mxmp-editor-form>
    `}});const Xt=[{type:"string",name:"entityNameRegexToReplace"},{type:"string",name:"entityNameReplacement"},{type:"boolean",name:"excludeItemsInEntitiesList"}],Rt=[{name:"entities",help:"Required, unless you have specified entity platform",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}}];class jt extends zt{render(){const e=this.config.predefinedGroups;return this.editGroup>-1?j`<mxmp-predefined-group-editor
          .index=${this.editGroup}
          .config=${this.config}
          .hass=${this.hass}
          @closed=${()=>this.editGroup=-1}
        ></mxmp-predefined-group-editor>`:j`
          <mxmp-editor-form
            .schema=${Rt}
            .config=${this.config}
            .hass=${this.hass}
          ...
          <div>
            Predefined Groups
            <ha-control-button-group>
              ${null==e?void 0:e.map(((e,t)=>j`
                  <ha-control-button @click=${()=>this.editGroup=t}>
                    ${e.name}<ha-svg-icon .path=${Be} label="Edit Group"></ha-svg-icon>
                  </ha-control-button>
                `))}
              <ha-control-button @click=${()=>this.editGroup=e?e.length:0}>
                Add group<ha-svg-icon .path=${Qe} label="Add Group"></ha-svg-icon>
              </ha-control-button>
            </ha-control-button-group>
          </div>
        ...
        `}}e([le()],jt.prototype,"editGroup",void 0),customElements.define("mxmp-entities-editor",jt);class Gt extends zt{constructor(){super(...arguments),this.schema=[{type:"string",name:"name",required:!0},{type:"string",name:"media"},{type:"boolean",name:"excludeItemsInEntitiesList"},{name:"entities",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}}]}render(){return this.predefinedGroup||this.initPredefinedGroup(),j`
      ...
      <div>
        ...
        ${this.predefinedGroup.entities.map((({player:e,volume:t})=>{var A,i;const s=[{type:"integer",name:"volume",label:`${null!==(i=null===(A=this.hass.states[e])||void 0===A?void 0:A.attributes.friendly_name)&&void 0!==i?i:""}${void 0!==t?`: ${t}`:""}`,valueMin:0,valueMax:100}];return j`
            <mxmp-editor-form
              .data=${{volume:t}}
              .schema=${s}
              .config=${this.config}
    ...
    `}changed(e,t){const A=e.detail.value;let i=this.config.mediaArtworkOverrides;Array.isArray(i)||(i=[]),i[t]?i[t]=A:i=[...i,A],this.config.mediaArtworkOverrides=i,this.configChanged()}}e([ae({type:Number})],qt.prototype,"index",void 0),customElements.define("mxmp-artwork-override-editor",qt);class Zt extends zt{render(){return j`
      <ha-form
      ...
      ></ha-form>
    `}valueChanged(e){const t=e.detail.value;this.config=Object.assign(Object.assign({},this.config),t),this.configChanged()}}function Yt({help:e,label:t,name:A}){if(t)return t;let i=A.replace(/([A-Z])/g," $1");return i=i.charAt(0).toUpperCase()+i.slice(1),i+(e?` (${e})`:"")}e([ae({attribute:!1})],Zt.prototype,"schema",void 0),e([ae({attribute:!1})],Zt.prototype,"data",void 0),e([ae()],Zt.prototype,"changed",void 0),customElements.define("mxmp-editor-form",Zt);const{GENERAL:Jt,ENTITIES:Ft,ADVANCED:Kt,ARTWORK:$t}=Ht;class _t extends zt{constructor(){super(...arguments),this.configArea=Jt}render(){return this.config.sections&&0!==this.config.sections.length||(this.config.sections=[de.PLAYER,de.VOLUMES,de.GROUPS,de.GROUPING,de.MEDIA_BROWSER]),j`
      <ha-control-button-group>
        ${[Jt,Ft,$t,Kt].map((e=>j`
            <ha-control-button
      ...
      ${this.subEditor()}
    `}subEditor(){return ht(this.configArea,[[Jt,()=>j`<mxmp-general-editor .config=${this.config} .hass=${this.hass}></mxmp-general-editor>`],[Ft,()=>j`<mxmp-entities-editor .config=${this.config} .hass=${this.hass}></mxmp-entities-editor>`],[Kt,()=>j`<mxmp-advanced-editor .config=${this.config} .hass=${this.hass}></mxmp-advanced-editor>`],[$t,()=>j`<mxmp-artwork-overrides-editor
            .config=${this.config}
            .hass=${this.hass}
          ></mxmp-artwork-overrides-editor>`]])}static get styles(){return o`
...
function eA(e,t,A){return e?t(e):A?.(e)}e([le()],_t.prototype,"configArea",void 0),customElements.define("mxmp-editor",_t);const{GROUPING:tA,GROUPS:AA,MEDIA_BROWSER:iA,PLAYER:sA,VOLUMES:rA}=de;class oA extends se{constructor(){super(...arguments),this.showSectionListener=e=>{const t=e.detail;(!this.config.sections||this.config.sections.indexOf(t)>-1)&&(this.section=t)},this.callMediaStartedListener=e=>{this.showLoader||this.config.sections&&e.detail.section!==this.section||(this.cancelLoader=!1,setTimeout((()=>{this.cancelLoader||(this.showLoader=!0,this.loaderTimestamp=Date.now())}),300))},this.callMediaDoneListener=()=>{this.cancelLoader=!0;const e=Date.now()-this.loaderTimestamp;this.showLoader&&(e<1e3?setTimeout((()=>this.showLoader=!1),1e3-e):this.showLoader=!1)},this.activePlayerListener=e=>{var t;const A=e.detail.entityId;A!==this.activePlayerId&&(this.activePlayerId=A,(null===(t=this.config.sections)||void 0===t?void 0:t.includes(sA))&&(this.section=sA),this.requestUpdate())},this.onMediaItemSelected=()=>{var e;(null===(e=this.config.sections)||void 0===e?void 0:e.includes(sA))&&setTimeout((()=>this.section=sA),1e3)}}render(){this.createStore();let e=At(this.config.heightPercentage);const t=this.config.sections,A=!t||t.length>1,i=A?e-5:e,s=this.config.title;return e=s?e+2:e,j`
      <ha-card style=${this.haCardStyle(e)}>
        ...
        ${s?j`<div class="title">${s}</div>`:j``}
        <div class="content" style=${this.contentStyle(i)}>
          ${this.activePlayerId?ht(this.section,[[sA,()=>j` <mxmp-player .store=${this.store}></mxmp-player>`],[AA,()=>j` <mxmp-groups
                        .store=${this.store}
                        @active-player=${this.activePlayerListener}
                      ></mxmp-groups>`],[tA,()=>j`<mxmp-grouping
                        .store=${this.store}
                        @active-player=${this.activePlayerListener}
                      ></mxmp-grouping>`],[iA,()=>j`
                      <mxmp-media-browser
                      ...
                      ></mxmp-media-browser>
                    `],[rA,()=>j` <mxmp-volumes .store=${this.store}></mxmp-volumes>`]]):j`<div class="no-players">No supported players found</div>`}
        </div>
        ${eA(A,(()=>j`<mxmp-footer
    ...
    `}createStore(){var e;this.activePlayerId?this.store=new wt(this.hass,this.config,this.section,this,this.activePlayerId):(this.store=new wt(this.hass,this.config,this.section,this),this.activePlayerId=null===(e=this.store.activePlayer)||void 0===e?void 0:e.id)}getCardSize(){return 3}static getConfigElement(){return document.createElement("mxmp-editor")}connectedCallback(){super.connectedCallback(),_e(this.config)&&window.addEventListener(We,this.activePlayerListener),window.addEventListener(De,this.callMediaStartedListener),window.addEventListener(qe,this.callMediaDoneListener)}disconnectedCallback(){window.removeEventListener(We,this.activePlayerListener),super.disconnectedCallback()}haCardStyle(e){const t=At(this.config.widthPercentage);return nt({color:"var(--secondary-text-color)",height:`${e}rem`,minWidth:"20rem",maxWidth:`${t}rem`,overflow:"hidden"})}footerStyle(){return nt({height:"5rem",paddingBottom:"1rem"})}contentStyle(e){return nt({overflowY:"auto",height:`${e}rem`})}setConfig(e){var t;const A=JSON.parse(JSON.stringify(e));for(const[e,t]of Object.entries(A))Array.isArray(t)&&0===t.length&&delete A[e];const i=A.sections;this.section=i?i.includes(sA)?sA:i.includes(iA)?iA:i.includes(AA)?AA:i.includes(tA)?tA:rA:sA,A.mediaBrowserItemsPerRow=A.mediaBrowserItemsPerRow||4,(null===(t=A.entities)||void 0===t?void 0:t.length)&&A.entities[0].entity&&(A.entities=A.entities.map((e=>e.entity))),this.config=A}static get styles(){return o`
      :host {
    ...
    `}}e([ae({attribute:!1})],oA.prototype,"hass",void 0),e([ae({attribute:!1})],oA.prototype,"config",void 0),e([le()],oA.prototype,"section",void 0),e([le()],oA.prototype,"store",void 0),e([le()],oA.prototype,"showLoader",void 0),e([le()],oA.prototype,"loaderTimestamp",void 0),e([le()],oA.prototype,"cancelLoader",void 0),e([le()],oA.prototype,"activePlayerId",void 0);class nA extends se{render(){const e=!!this.icon&&!!this.name||W;return j`
      <ha-control-button>
        ${this.icon?j` <ha-icon icon-and-name=${e} .icon=${this.icon}></ha-icon>`:""}
        ${this.name?j`<span>${this.name}</span>`:""}
      </ha-control-button>
    ...
    `}}e([ae()],nA.prototype,"icon",void 0),e([ae()],nA.prototype,"name",void 0),customElements.define("mxmp-grouping-button",nA);class aA extends se{constructor(){super(...arguments),this.modifiedItems=[]}render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService,this.mediaPlayerIds=this.store.allMediaPlayers.map((e=>e.id)),this.groupingItems=this.getGroupingItems(),this.notJoinedPlayers=this.getNotJoinedPlayers(),this.joinedPlayers=this.getJoinedPlayers(),this.store.config.skipApplyButtonWhenGrouping&&this.modifiedItems.length>0&&this.applyGrouping(),j`
      <div class="wrapper">
        <div class="predefined-groups">
          ${this.renderJoinAllButton()} ${this.renderUnJoinAllButton()}
          ${eA(this.store.predefinedGroups,(()=>this.renderPredefinedGroups()))}
        </div>
        <div class="list">
        ...
        <ha-control-button-group
          class="buttons"
          hide=${0===this.modifiedItems.length||this.store.config.skipApplyButtonWhenGrouping||W}
        >
    ...
    `}static get styles(){return[Ye,o`
      ...
      `]}toggleItem(e){e.isDisabled||this.toggleItemWithoutDisabledCheck(e)}toggleItemWithoutDisabledCheck(e){this.modifiedItems.includes(e.player.id)?this.modifiedItems=this.modifiedItems.filter((t=>t!==e.player.id)):this.modifiedItems=[...this.modifiedItems,e.player.id]}async applyGrouping(){const e=this.groupingItems.filter((e=>e.isSelected)),t=this.groupingItems.filter((e=>!e.isSelected&&this.joinedPlayers.includes(e.player.id))).map((e=>e.player.id)),A=this.groupingItems.filter((e=>e.isSelected&&!this.joinedPlayers.includes(e.player.id))).map((e=>e.player.id));let i=this.activePlayer.id;A.length>0&&await this.mediaControlService.join(i,A),t.length>0&&await this.mediaControlService.unJoin(t),await this.handlePredefinedGroupConfig(e),t.includes(this.activePlayer.id)&&(i=this.store.config.dontSwitchPlayerWhenGrouping?this.activePlayer.id:e[0].player.id,$e(i,this.store.config,this)),this.config.entityId&&t.includes(this.config.entityId)&&this.config.dontSwitchPlayerWhenGrouping&&$e(this.config.entityId,this.config,this),this.modifiedItems=[]}async handlePredefinedGroupConfig(e){const t=this.store.predefinedGroups.find((t=>t.entities.length===e.length&&t.entities.every((t=>e.some((e=>e.player.id===t.player.id))))));t&&await this.mediaControlService.setVolumeAndMediaForPredefinedGroup(t)}cancelGrouping(){this.modifiedItems=[]}getGroupingItems(){const e=this.store.allMediaPlayers.map((e=>new lA(e,this.activePlayer,this.modifiedItems.includes(e.id)))),t=e.filter((e=>e.isSelected));return 1===t.length&&(t[0].isDisabled=!0),e}renderJoinAllButton(){return eA(this.notJoinedPlayers.length,(()=>this.groupingButton("mdi:checkbox-multiple-marked-outline",this.selectAll)))}groupingButton(e,t){return j` <mxmp-grouping-button @click=${t} .icon=${e}></mxmp-grouping-button> `}getNotJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e!==this.activePlayer.id&&!this.activePlayer.hasMember(e)))}renderUnJoinAllButton(){return eA(this.joinedPlayers.length,(()=>this.groupingButton("mdi:minus-box-multiple-outline",this.deSelectAll)))}getJoinedPlayers(){return this.mediaPlayerIds.filter((e=>e===this.activePlayer.id||this.activePlayer.hasMember(e)))}renderPredefinedGroups(){return this.store.predefinedGroups.map((e=>j`
        <mxmp-grouping-button
          @click=${async()=>this.selectPredefinedGroup(e)}
          .icon=${"mdi:speaker-multiple"}
          .name=${e.name}
        ></mxmp-grouping-button>
      `))}selectPredefinedGroup(e){this.groupingItems.forEach((async t=>{const A=e.entities.some((e=>e.player.id===t.player.id));(A&&!t.isSelected||!A&&t.isSelected)&&this.toggleItemWithoutDisabledCheck(t)}))}selectAll(){this.groupingItems.forEach((e=>{e.isSelected||this.toggleItem(e)}))}deSelectAll(){this.groupingItems.forEach((e=>{(!e.isMain&&e.isSelected||e.isMain&&!e.isSelected)&&this.toggleItem(e)}))}}e([ae({attribute:!1})],aA.prototype,"store",void 0),e([le()],aA.prototype,"modifiedItems",void 0);class lA{constructor(e,t,A){this.isDisabled=!1,this.isMain=e.id===t.id,this.isModified=A;const i=this.isMain||t.hasMember(e.id);this.isSelected=A?!i:i,this.player=e,this.name=e.name,this.icon=this.isSelected?"check-circle":"checkbox-blank-circle-outline"}}class cA extends se{constructor(){super(...arguments),this.selected=!1,this.dispatchEntityIdEvent=()=>{if(this.selected){$e(this.player.id,this.store.config,this)}}}render(){const e=this.store.config.hideGroupCurrentTrack?"":this.player.getCurrentTrack(),t=Ke(this.player,this.store.predefinedGroups),A=this.player.attributes.icon;return j`
      <mwc-list-item
        hasMeta
    ...
    `}connectedCallback(){super.connectedCallback(),this.dispatchEntityIdEvent()}handleGroupClicked(){if(!this.selected){this.selected=!0;const e=window.location.href.replace(/#.*/g,"");window.location.replace(`${e}#${this.player.id}`),this.dispatchEntityIdEvent()}}static get styles(){return o`
      @keyframes sound {
        0% {
          opacity: 0.35;
          height: 0.15rem;
    ...
    `}}e([ae({attribute:!1})],cA.prototype,"store",void 0),e([ae({attribute:!1})],cA.prototype,"player",void 0),e([ae({type:Boolean})],cA.prototype,"selected",void 0),customElements.define("mxmp-group",cA);class dA extends se{render(){return this.activePlayer=this.store.activePlayer,this.groups=this.store.allGroups,j`
      <mwc-list activatable class="list">
        ${this.groups.map((e=>{const t=this.activePlayer.id===e.id;return j` <mxmp-group .store=${this.store} .player=${e} .selected=${t}></mxmp-group> `}))}
      </mwc-list>
    `}static get styles(){return Ye}}e([ae({attribute:!1})],dA.prototype,"store",void 0);class hA extends se{render(){return this.config=this.store.config,j`
      <mwc-list multi class="list">
        ${mt(this.items,this.config).map(((e,t)=>j`
            ${pt(e.thumbnail,t)}
            <mwc-list-item class="button" @click=${()=>this.dispatchEvent(et(Ze,e))}>
              <div class="row">${vt(e)}</div>
            </mwc-list-item>
          `))}
      </mwc-list>
    `}static get styles(){return[o`
      ...
      `,Je,Ye]}}e([ae({attribute:!1})],hA.prototype,"store",void 0),e([ae({type:Array})],hA.prototype,"items",void 0),customElements.define("mxmp-media-browser-list",hA);class EA extends se{render(){return this.config=this.store.config,j`
      <style>
        :host {
      ...
      <div class="icons">
        ${mt(this.items,this.config).map(((e,t)=>j`
            ...
            <ha-control-button
              class="button"
              @click=${()=>this.dispatchEvent(et(Ze,e))}
            >
              ${vt(e,!e.thumbnail||!this.config.mediaBrowserHideTitleForThumbnailIcons)}
            </ha-control-button>
          `))}
      </div>
    `}static get styles(){return[Je,o`
        .icons {
          display: flex;
          flex-wrap: wrap;
        }
      ...
      `]}}e([ae({attribute:!1})],EA.prototype,"store",void 0),e([ae({attribute:!1})],EA.prototype,"items",void 0),customElements.define("mxmp-media-browser-icons",EA);class gA extends se{render(){var e;return j`
    ...
    `}}e([ae({attribute:!1})],gA.prototype,"store",void 0),customElements.define("mxmp-media-browser-header",gA);class BA extends se{constructor(){super(...arguments),this.onMediaItemSelected=e=>{const t=e.detail;this.playItem(t),this.dispatchEvent(et(Ze,t))}}render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaBrowseService=this.store.mediaBrowseService,this.mediaControlService=this.store.mediaControlService,j`
      <mxmp-media-browser-header .store=${this.store}></mxmp-media-browser-header>

      ${this.activePlayer&&ke(this.getFavorites(this.activePlayer).then((e=>{var t;return(null==e?void 0:e.length)?(null!==(t=this.config.mediaBrowserItemsPerRow)&&void 0!==t?t:4)>1?j`
                ...
                `:j`
                  <mxmp-media-browser-list
                    ...
                    @item-selected=${this.onMediaItemSelected}
                  ></mxmp-media-browser-list>
                `:j`<div class="no-items">No favorites found</div>`})))}
    `}async playItem(e){e.media_content_type||e.media_content_id?await this.mediaControlService.playMedia(this.activePlayer,e):await this.mediaControlService.setSource(this.activePlayer,e.title)}async getFavorites(e){var t,A,i,s;let r=await this.mediaBrowseService.getFavorites(e);return r.sort(((e,t)=>this.sortOnTopFavoritesThenAlphabetically(e.title,t.title))),r=[...(null===(A=null===(t=this.config.customSources)||void 0===t?void 0:t[this.activePlayer.id])||void 0===A?void 0:A.map(BA.createSource))||[],...(null===(s=null===(i=this.config.customSources)||void 0===i?void 0:i.all)||void 0===s?void 0:s.map(BA.createSource))||[],...r],this.config.numberOfFavoritesToShow?r.slice(0,this.config.numberOfFavoritesToShow):r}sortOnTopFavoritesThenAlphabetically(e,t){var A;const i=null!==(A=this.config.topFavorites)&&void 0!==A?A:[],s=ut(i,e),r=ut(i,t);if(s>-1&&r>-1)return s-r;{let A=r-s;return 0===A&&(A=e.localeCompare(t,"en",{sensitivity:"base"})),A}}static createSource(e){return Object.assign(Object.assign({},e),{can_play:!0})}static get styles(){return o`
      .no-items {
        text-align: center;
        margin-top: 50%;
      }
    `}}e([ae({attribute:!1})],BA.prototype,"store",void 0);const{SELECT_SOURCE:QA}=he;class uA extends se{constructor(){super(...arguments),this.showSwitches={}}render(){this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.hassService=this.store.hassService,this.mediaControlService=this.store.mediaControlService;const e=this.activePlayer.members;return j`
      ${eA(e.length>1,(()=>this.volumeWithName(this.activePlayer)))}
      ${e.map((e=>this.volumeWithName(e,!1)))}
    `}volumeWithName(e,t=!0){var A;const i=t?null!==(A=this.config.labelForTheAllVolumesSlider)&&void 0!==A?A:"All":e.name,s=!!this.config.showVolumeUpAndDownButtons&&W,r=t||!this.showSwitches[e.id];return j` <div class="row">
      ...
      <div class="slider-row">
        <ha-icon-button
          ...
          .path=${ue}
        ></ha-icon-button>
        <mxmp-volume .store=${this.store} .player=${e} .updateMembers=${t}></mxmp-volume>
        <ha-icon-button
          .disabled=${e.ignoreVolume}
          hide=${s}
      ...
      <div class="switches">
        <mxmp-ha-player hide=${r||W} .store=${this.store} .features=${[QA]}>
        </mxmp-ha-player>
        ${ke(this.getAdditionalControls(r,e))}
      </div>
    ...
    `}}e([ae({attribute:!1})],uA.prototype,"store",void 0),e([le()],uA.prototype,"showSwitches",void 0),customElements.define("mxmp-volumes",uA);class mA extends se{render(){const e=this.store.hass.states[this.store.activePlayer.id];let t=0;this.features.forEach((e=>t+=e));const A=Object.assign(Object.assign({},e),{attributes:Object.assign(Object.assign({},e.attributes),{supported_features:t})});return j` <more-info-content .stateObj=${A} .hass=${this.store.hass}></more-info-content> `}}e([ae({attribute:!1})],mA.prototype,"store",void 0),e([ae({attribute:!1})],mA.prototype,"features",void 0),customElements.define("mxmp-ha-player",mA),window.customCards.push({type:"maxi-media-player",name:"Maxi Media Player",description:"Media card for Home Assistant UI with a focus on managing multiple media players",preview:!0}),customElements.define("maxi-media-player",oA),customElements.define("mxmp-grouping",aA),customElements.define("mxmp-groups",dA),customElements.define("mxmp-media-browser",BA),customElements.define("mxmp-player",dt);
//# sourceMappingURL=maxi-media-player.js.map
