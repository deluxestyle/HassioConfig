 ...
 */const Oe=e=>!(e=>null===e||"object"!=typeof e&&"function"!=typeof e)(e)&&"function"==typeof e.then,Me=1073741823;const ke=fe(class extends xe{constructor(){super(...arguments),this.wt=Me,this.bt=[],this.K=new Le(this),this.X=new Ve}render(...e){return e.find((e=>!Oe(e)))??G}update(e,t){const A=this.bt;let i=A.length;this.bt=t;const s=this.K,r=this.X;this.isConnected||this.disconnected();for(let e=0;e<t.length&&!(e>this.wt);e++){const o=t[e];if(!Oe(o))return this.wt=e,o;e<i&&o===A[e]||(this.wt=Me,i=0,Promise.resolve(o).then((async e=>{for(;r.get();)await r.get();const t=s.deref();if(void 0!==t){const A=t.bt.indexOf(o);A>-1&&A<t.wt&&(t.wt=A,t.setValue(e))}})))}return G}disconnected(){this.K.disconnect(),this.X.pause()}reconnected(){this.K.reconnect(this),this.X.resume()}}),{SHUFFLE_SET:He,REPEAT_SET:ze,PLAY:Ne,PAUSE:Te,NEXT_TRACK:Ue,PREVIOUS_TRACK:Xe,BROWSE_MEDIA:Re}=he;class je extends se{constructor(){super(...arguments),this.volDown=async()=>await this.mediaControlService.volumeDown(this.volumePlayer,!this.config.playerVolumeEntityId),this.volUp=async()=>await this.mediaControlService.volumeUp(this.volumePlayer,!this.config.playerVolumeEntityId),this.rewind=async()=>await this.mediaControlService.seek(this.volumePlayer,this.volumePlayer.attributes.media_position-(this.config.fastForwardAndRewindStepSizeSeconds||15)),this.fastForward=async()=>await this.mediaControlService.seek(this.volumePlayer,this.volumePlayer.attributes.media_position+(this.config.fastForwardAndRewindStepSizeSeconds||15))}render(){var e;this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaControlService=this.store.mediaControlService;const t=!!this.config.showVolumeUpAndDownButtons&&W,A=!!this.config.showFastForwardAndRewindButtons&&W;return this.volumePlayer=null!==(e=this.activePlayer.getMember(this.config.playerVolumeEntityId))&&void 0!==e?e:this.activePlayer,j`
  ...
  `}async getAudioInputFormat(){const e=(await this.store.hassService.getRelatedEntities(this.activePlayer,"sensor")).find((e=>e.entity_id.includes("audio_input_format")));return e&&e.state&&"No audio"!==e.state?j`<div>${e.state}</div>`:""}showShuffle(){return this.config.hidePlayerControlShuffleButton?[]:[He]}showPrev(){return this.config.hidePlayerControlPrevTrackButton?[]:[Xe]}showNext(){return this.config.hidePlayerControlNextTrackButton?[]:[Ue]}showRepeat(){return this.config.hidePlayerControlRepeatButton?[]:[ze]}showBrowseMedia(){return this.config.showBrowseMediaInPlayerSection?[Re]:[]}static get styles(){return o`
      .main {
...
const Et=(e,t,A)=>{for(const A of t)if(A[0]===e)return(0,A[1])();return A?.()};class Bt{constructor(e,t,A,i){this.hass=e,this.currentSection=t,this.card=A,this.config=i}async callMediaService(e,t){this.card.dispatchEvent(tt(qe,{section:this.currentSection}));try{await this.hass.callService("media_player",e,t)}finally{this.card.dispatchEvent(tt(Ze))}}async browseMedia(e,t,A){var i;const s=await this.hass.callWS({type:"media_player/browse_media",entity_id:e.id,media_content_id:A,media_content_type:t});return this.config.replaceHttpWithHttpsForThumbnails&&(s.children=null===(i=s.children)||void 0===i?void 0:i.map((e=>{var t;return Object.assign(Object.assign({},e),{thumbnail:null===(t=e.thumbnail)||void 0===t?void 0:t.replace("http://","https://")})}))),s}async getRelatedEntities(e,...t){return new Promise((async(A,i)=>{const s={type:"render_template",template:"{{ device_entities(device_id('"+e.id+"')) }}"};try{const e=await this.hass.connection.subscribeMessage((i=>{e(),A(i.result.filter((e=>t.some((t=>e.includes(t))))).map((e=>this.hass.states[e])))}),s)}catch(e){i(e)}}))}}const ut="data:image/png;base64,";function Qt(e,t){for(const A in e)if(mt(A)===mt(t))return e[A]}function mt(e){return e.replace(/[^a-zA-Z ]/g,"")}function pt(e,t){let A=-1;return e.forEach(((e,i)=>{mt(e)===mt(t)&&(A=i)})),A}function vt(e,t){const A=e.some((e=>e.thumbnail));return e.map((e=>{const i=function(e,t,A){var i,s;let r=null!==(i=Qt(t.customThumbnail,e.title))&&void 0!==i?i:e.thumbnail;return r?(null==r?void 0:r.match(/https:\/\/brands\.home-assistant\.io\/.+\/logo.png/))&&(r=null==r?void 0:r.replace("logo.png","icon.png")):(r=Qt(t.customThumbnailIfMissing,e.title),A&&!r&&(r=(null===(s=t.customThumbnailIfMissing)||void 0===s?void 0:s.default)||ut)),r||""}(e,t,A);return Object.assign(Object.assign({},e),{thumbnail:i})}))}function ft(e,t=!0){return j`
  ...
  `}class Ct{constructor(e,t){this.hassService=e,this.config=t}async getFavorites(e){if(!e)return[];let t=await this.getFavoritesForPlayer(e);return t=t.flatMap((e=>e)),t=this.removeDuplicates(t),t=t.length?t:this.getFavoritesFromStates(e),t.filter((e=>{var t;return-1===pt(null!==(t=this.config.favoritesToIgnore)&&void 0!==t?t:[],e.title)}))}removeDuplicates(e){return e.filter(((e,t,A)=>t===A.findIndex((t=>t.title===e.title))))}async getFavoritesForPlayer(e){var t;try{const A=null===(t=(await this.hassService.browseMedia(e,"favorites","")).children)||void 0===t?void 0:t.map((t=>this.hassService.browseMedia(e,t.media_content_type,t.media_content_id)));return(A?await Promise.all(A):[]).flatMap((e=>{var t;return null!==(t=e.children)&&void 0!==t?t:[]}))}catch(t){return console.log(`Maxi Media Player: error getting favorites for player ${e.id}: ${JSON.stringify(t)}`),[]}}getFavoritesFromStates(e){return(e.attributes.hasOwnProperty("source_list")?e.attributes.source_list:[]).map((e=>({title:e})))}}class yt{constructor(e,t){this.hassService=e,this.config=t}async join(e,t){await this.hassService.callMediaService("join",{entity_id:e,group_members:t})}async unJoin(e){await this.hassService.callMediaService("unjoin",{entity_id:e})}async setVolumeAndMediaForPredefinedGroup(e){var t;for(const A of e.entities){const i=null!==(t=A.volume)&&void 0!==t?t:e.volume;i&&await this.volumeSetSinglePlayer(A.player,i),e.unmuteWhenGrouped&&await this.setVolumeMute(A.player,!1,!1)}e.media&&await this.setSource(e.entities[0].player,e.media)}async volumeDown(e,t=!0){await this.volumeStep(e,t,this.getStepDownVolume,"volume_down")}async volumeUp(e,t=!0){await this.volumeStep(e,t,this.getStepUpVolume,"volume_up")}async volumeStep(e,t,A,i){this.config.volumeStepSize?await this.volumeWithStepSize(e,t,this.config.volumeStepSize,A):await this.volumeDefaultStep(e,t,i)}async volumeWithStepSize(e,t,A,i){for(const s of e.members)if(e.id===s.id||t){const e=i(s,A);await this.volumeSetSinglePlayer(s,e)}}getStepDownVolume(e,t){return Math.max(0,e.getVolume()-t)}getStepUpVolume(e,t){return Math.min(100,e.getVolume()+t)}async volumeDefaultStep(e,t,A){for(const i of e.members)(e.id===i.id||t)&&(i.ignoreVolume||await this.hassService.callMediaService(A,{entity_id:i.id}))}async volumeSet(e,t,A){return A?await this.volumeSetGroup(e,t):await this.volumeSetSinglePlayer(e,t)}async volumeSetGroup(e,t){let A;this.config.adjustVolumeRelativeToMainPlayer&&(A=t/e.getVolume()),await Promise.all(e.members.map((e=>{let i=t;return void 0!==A&&this.config.adjustVolumeRelativeToMainPlayer&&(i=e.getVolume()*A,i=Math.min(100,Math.max(0,i))),this.volumeSetSinglePlayer(e,i)})))}async volumeSetSinglePlayer(e,t){if(!e.ignoreVolume){const A=t/100;await this.hassService.callMediaService("volume_set",{entity_id:e.id,volume_level:A})}}async toggleMute(e,t=!0){const A=!e.isMuted(t);await this.setVolumeMute(e,A,t)}async setVolumeMute(e,t,A=!0){for(const i of e.members)(e.id===i.id||A)&&await this.hassService.callMediaService("volume_mute",{entity_id:i.id,is_volume_muted:t})}async setSource(e,t){await this.hassService.callMediaService("select_source",{source:t,entity_id:e.id})}async playMedia(e,t){await this.hassService.callMediaService("play_media",{entity_id:e.id,media_content_id:t.media_content_id,media_content_type:t.media_content_type})}async seek(e,t){await this.hassService.callMediaService("media_seek",{entity_id:e.id,seek_position:t})}}class bt{constructor(e,t,A){var i;this.id=e.entity_id,this.config=t,this.name=this.getEntityName(e,t),this.state=e.state,this.attributes=e.attributes,this.members=A?this.createGroupMembers(e,A):[this],this.volumePlayer=this.determineVolumePlayer(),this.ignoreVolume=!!(null===(i=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===i?void 0:i.includes(this.volumePlayer.id))}getMember(e){return this.members.find((t=>t.id===e))}hasMember(e){return void 0!==this.getMember(e)}isPlaying(){return"playing"===this.state}isMuted(e){return this.attributes.is_volume_muted&&(!e||this.members.every((e=>e.isMuted(!1))))}getCurrentTrack(){return`${this.attributes.media_artist||""} - ${this.attributes.media_title||""}`.replace(/^ - | - $/g,"")}getEntityName(e,t){const A=e.attributes.friendly_name||"";return t.entityNameRegexToReplace?A.replace(new RegExp(t.entityNameRegexToReplace,"g"),t.entityNameReplacement||""):A}createGroupMembers(e,t){return st(e).reduce(((e,A)=>{const i=t.find((e=>e.entity_id===A));return i?[...e,new bt(i,this.config)]:e}),[])}determineVolumePlayer(){let e;return this.members.length>1&&this.config.entitiesToIgnoreVolumeLevelFor&&(e=this.members.find((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))}))),null!=e?e:this}getVolume(){let e;return e=this.members.length>1&&this.config.adjustVolumeRelativeToMainPlayer?this.getAverageVolume():100*this.volumePlayer.attributes.volume_level,Math.round(e)}getAverageVolume(){const e=this.members.filter((e=>{var t;return!(null===(t=this.config.entitiesToIgnoreVolumeLevelFor)||void 0===t?void 0:t.includes(e.id))})).map((e=>e.attributes.volume_level));return 100*e.reduce(((e,t)=>e+t),0)/e.length}}const{TURN_OFF:It,TURN_ON:wt}=he;class Pt{constructor(e,t,A,i,s){this.hass=e,this.config=t;const r=this.getMediaPlayerHassEntities(this.hass);this.allGroups=this.createPlayerGroups(r),this.allMediaPlayers=this.allGroups.reduce(((e,t)=>[...e,...t.members]),[]).sort(((e,t)=>e.name.localeCompare(t.name))),this.activePlayer=this.determineActivePlayer(s),this.hassService=new Bt(this.hass,A,i,t),this.mediaControlService=new yt(this.hassService,t),this.mediaBrowseService=new Ct(this.hassService,t),this.predefinedGroups=this.createPredefinedGroups()}createPredefinedGroups(){const e=[];if(this.config.predefinedGroups)for(const t of this.config.predefinedGroups){const A=this.createPredefinedGroup(t);A&&e.push(A)}return e}createPredefinedGroup(e){let t;const A=[];let i=e.entities;e.excludeItemsInEntitiesList&&(i=this.convertExclusionsInPredefinedGroupsToInclusions(i));for(const e of i){const t=this.createPredefinedGroupPlayer(e);t&&A.push(t)}return A.length&&(t=Object.assign(Object.assign({},e),{entities:A})),t}convertExclusionsInPredefinedGroupsToInclusions(e){return this.allMediaPlayers.filter((t=>!e.find((e=>("string"==typeof e?e:e.player)===t.id)))).map((e=>e.id))}createPredefinedGroupPlayer(e){var t;let A,i,s;if("string"==typeof e?A=e:(i=e.volume,A=e.player),"unavailable"!==(null===(t=this.hass.states[A])||void 0===t?void 0:t.state)){const e=this.allMediaPlayers.find((e=>e.id===A));e&&(s={player:e,volume:i})}else console.warn(`Player ${A} is unavailable`);return s}getMediaPlayerHassEntities(e){const t=e;return Object.values(e.states).filter((e=>!!e.entity_id.includes("media_player")&&(rt(this.config)?function(e,t,A){var i,s;const r=[...new Set(e.entities)];let o=!0;if(r.length){const A=r.includes(t.entity_id);o=!!e.excludeItemsInEntitiesList!==A}let n=!0;e.entityPlatform&&(n=(null===(s=null===(i=A.entities)||void 0===i?void 0:i[t.entity_id])||void 0===s?void 0:s.platform)===e.entityPlatform);return o&&n}(this.config,e,t):function(e,t,A){var i,s;const r=[...new Set(e.entities)];if(e.entityPlatform)return(null===(s=null===(i=A.entities)||void 0===i?void 0:i[t.entity_id])||void 0===s?void 0:s.platform)===e.entityPlatform;if(r.length){const A=r.includes(t.entity_id);return!!e.excludeItemsInEntitiesList!==A}return!1}(this.config,e,t)))).sort(((e,t)=>e.entity_id.localeCompare(t.entity_id)))}createPlayerGroups(e){return e.filter((t=>this.isMainPlayer(t,e))).map((t=>this.createPlayerGroup(t,e))).filter((e=>void 0!==e))}isMainPlayer(e,t){var A;try{const i=st(e).filter((e=>t.some((t=>t.entity_id===e)))),s=(null==i?void 0:i.length)>1,r=s&&i&&i[0]===e.entity_id,o="unavailable"!==(null===(A=this.hass.states[e.entity_id])||void 0===A?void 0:A.state);return o||console.warn(`Player ${e.entity_id} is unavailable`),(!s||r)&&o}catch(t){return console.error("Failed to determine main player",JSON.stringify(e),t),!1}}createPlayerGroup(e,t){try{return new bt(e,this.config,t)}catch(t){return void console.error("Failed to create group",JSON.stringify(e),t)}}determineActivePlayer(e){const t=e||this.config.entityId||this.getActivePlayerFromUrl();return this.allGroups.find((e=>void 0!==e.getMember(t)))||this.allGroups.find((e=>e.isPlaying()))||this.allGroups[0]}getActivePlayerFromUrl(){return window.location.href.includes("#")?window.location.href.replace(/.*#/g,""):""}showPower(e=!1){return this.config.hidePlayerControlPowerButton?[]:((this.activePlayer.attributes.supported_features||0)&Ke)!=Ke||e&&"off"!==this.activePlayer.state?[]:[wt,It]}}const{GROUPING:St,GROUPS:xt,MEDIA_BROWSER:Lt,PLAYER:Vt,VOLUMES:Ot}=de;class Mt extends se{render(){return j`
      ...
      ></ha-icon-button>
    `}dispatchSection(e){this.dispatchEvent(tt("show-section",e))}selected(e){return this.section===e||W}hide(e){var t;return this.config.sections&&!(null===(t=this.config.sections)||void 0===t?void 0:t.includes(e))||W}static get styles(){return o`
      :host {
        display: flex;
    ...
    `}}var kt,Ht;e([ae({attribute:!1})],Mt.prototype,"config",void 0),e([ae()],Mt.prototype,"section",void 0),customElements.define("mxmp-footer",Mt),function(e){e.language="language",e.system="system",e.comma_decimal="comma_decimal",e.decimal_comma="decimal_comma",e.space_comma="space_comma",e.none="none"}(kt||(kt={})),function(e){e.language="language",e.system="system",e.am_pm="12",e.twenty_four="24"}(Ht||(Ht={}));var zt;class Nt extends se{setConfig(e){this.config=JSON.parse(JSON.stringify(e))}static get styles(){return o`
      ha-svg-icon {
        margin: 5px;
      }
      ha-control-button {
    ...
    `}});const Rt=[{type:"string",name:"entityNameRegexToReplace"},{type:"string",name:"entityNameReplacement"},{type:"boolean",name:"excludeItemsInEntitiesList"}],jt=[{name:"entityId",help:"Not needed, but forces this player to be the selected one on loading the card (overrides url param etc)",selector:{entity:{multiple:!1,filter:{domain:"media_player"}}}},{name:"entities",help:"Required, unless you have specified entity platform",cardType:"maxi",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}},{name:"entities",help:"Not needed, unless you don't want to include all of them",cardType:"sonos",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}},{name:"showNonSonosPlayers",help:"Show all media players, including those that are not on the Sonos platform",cardType:"sonos",selector:{boolean:{}}}];class Gt extends Nt{constructor(){super(...arguments),this.entitiesSchema=jt}render(){const e=this.config.predefinedGroups;return this.entitiesSchema=jt.filter((e=>void 0===e.cardType||this.config.type.indexOf(e.cardType)>-1)),this.editGroup>-1?j`<mxmp-predefined-group-editor
        ...
        `}}e([le()],Gt.prototype,"editGroup",void 0),customElements.define("mxmp-entities-editor",Gt);class Wt extends Nt{constructor(){super(...arguments),this.schema=[{type:"string",name:"name",required:!0},{type:"string",name:"media"},{type:"boolean",name:"excludeItemsInEntitiesList"},{name:"entities",selector:{entity:{multiple:!0,filter:{domain:"media_player"}}}}]}render(){return this.predefinedGroup||this.initPredefinedGroup(),j`
    ...
    `}initPredefinedGroup(){var e;const t=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e[this.index||0];if(t){const e=t.entities.map((e=>"string"==typeof e?{player:e}:e));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:e})}else this.predefinedGroup={name:"",media:"",entities:[]}}getPredefinedGroupWithoutVolumes(){return Object.assign(Object.assign({},this.predefinedGroup),{entities:this.predefinedGroup.entities.map((e=>e.player))})}groupChanged(e){const t=e.detail.value,A=t.entities.map((e=>{const t=this.predefinedGroup.entities.find((({player:t})=>t===e));return null!=t?t:{player:e}}));this.predefinedGroup=Object.assign(Object.assign({},t),{entities:A})}volumeChanged(e,t){const A=e.detail.value.volume,i=this.predefinedGroup.entities.map((e=>e.player===t?Object.assign(Object.assign({},e),{volume:A}):e));this.predefinedGroup=Object.assign(Object.assign({},this.predefinedGroup),{entities:i})}savePredefinedGroup(){let e=this.config.predefinedGroups;Array.isArray(e)||(e=[]),e[this.index]?e[this.index]=this.predefinedGroup:e=[...e,this.predefinedGroup],this.config.predefinedGroups=e,this.configChanged(),this.dispatchClose()}deletePredefinedGroup(){var e;this.config.predefinedGroups=null===(e=this.config.predefinedGroups)||void 0===e?void 0:e.filter(((e,t)=>t!==this.index)),this.index=-1,this.configChanged(),this.dispatchClose()}}e([ae({type:Number})],Wt.prototype,"index",void 0),e([le()],Wt.prototype,"predefinedGroup",void 0),customElements.define("mxmp-predefined-group-editor",Wt);class Dt extends Nt{render(){const e=this.config.mediaArtworkOverrides;return this.editItem>-1?j`<mxmp-artwork-override-editor
        ...
        `}}e([le()],Dt.prototype,"editItem",void 0),customElements.define("mxmp-artwork-overrides-editor",Dt);const qt={ifMissing:!1};class Zt extends Nt{render(){var e;const t=null===(e=this.config.mediaArtworkOverrides)||void 0===e?void 0:e[this.index||0];return j`
    ...
    `}changed(e,t){const A=e.detail.value;let i=this.config.mediaArtworkOverrides;Array.isArray(i)||(i=[]),i[t]?i[t]=A:i=[...i,A],this.config.mediaArtworkOverrides=i,this.configChanged()}}e([ae({type:Number})],Zt.prototype,"index",void 0),customElements.define("mxmp-artwork-override-editor",Zt);class Jt extends Nt{render(){return j`
      <ha-form
    ...
    `}valueChanged(e){const t=e.detail.value;this.config=Object.assign(Object.assign({},this.config),t),this.configChanged()}}function Yt({help:e,label:t,name:A}){if(t)return t;let i=A.replace(/([A-Z])/g," $1");return i=i.charAt(0).toUpperCase()+i.slice(1),i+(e?` (${e})`:"")}e([ae({attribute:!1})],Jt.prototype,"schema",void 0),e([ae({attribute:!1})],Jt.prototype,"data",void 0),e([ae()],Jt.prototype,"changed",void 0),customElements.define("mxmp-editor-form",Jt);const{GENERAL:Ft,ENTITIES:Kt,ADVANCED:$t,ARTWORK:_t}=zt;class eA extends Nt{constructor(){super(...arguments),this.configArea=Ft}render(){return this.config.sections&&0!==this.config.sections.length||(this.config.sections=[de.PLAYER,de.VOLUMES,de.GROUPS,de.GROUPING,de.MEDIA_BROWSER]),j`
      ...
      ${this.subEditor()}
    `}subEditor(){return Et(this.configArea,[[Ft,()=>j`<mxmp-general-editor .config=${this.config} .hass=${this.hass}></mxmp-general-editor>`],[Kt,()=>j`<mxmp-entities-editor .config=${this.config} .hass=${this.hass}></mxmp-entities-editor>`],[$t,()=>j`<mxmp-advanced-editor .config=${this.config} .hass=${this.hass}></mxmp-advanced-editor>`],[_t,()=>j`<mxmp-artwork-overrides-editor
            .config=${this.config}
            .hass=${this.hass}
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
function tA(e,t,A){return e?t(e):A?.(e)}e([le()],eA.prototype,"configArea",void 0),customElements.define("mxmp-editor",eA);const{GROUPING:AA,GROUPS:iA,MEDIA_BROWSER:sA,PLAYER:rA,VOLUMES:oA}=de;class nA extends se{constructor(){super(...arguments),this.showSectionListener=e=>{const t=e.detail;(!this.config.sections||this.config.sections.indexOf(t)>-1)&&(this.section=t)},this.callMediaStartedListener=e=>{this.showLoader||this.config.sections&&e.detail.section!==this.section||(this.cancelLoader=!1,setTimeout((()=>{this.cancelLoader||(this.showLoader=!0,this.loaderTimestamp=Date.now())}),300))},this.callMediaDoneListener=()=>{this.cancelLoader=!0;const e=Date.now()-this.loaderTimestamp;this.showLoader&&(e<1e3?setTimeout((()=>this.showLoader=!1),1e3-e):this.showLoader=!1)},this.activePlayerListener=e=>{var t;const A=e.detail.entityId;A!==this.activePlayerId&&(this.activePlayerId=A,(null===(t=this.config.sections)||void 0===t?void 0:t.includes(rA))&&(this.section=rA),this.requestUpdate())},this.onMediaItemSelected=()=>{var e;(null===(e=this.config.sections)||void 0===e?void 0:e.includes(rA))&&setTimeout((()=>this.section=rA),1e3)}}render(){this.createStore();let e=it(this.config.heightPercentage);const t=this.config.sections,A=!t||t.length>1,i=A?e-5:e,s=this.config.title;return e=s?e+2:e,j`
      <ha-card style=${this.haCardStyle(e)}>
        ...
        <div class="content" style=${this.contentStyle(i)}>
          ${this.activePlayerId?Et(this.section,[[rA,()=>j` <mxmp-player .store=${this.store}></mxmp-player>`],[iA,()=>j` <mxmp-groups
                        .store=${this.store}
                        @active-player=${this.activePlayerListener}
                      ></mxmp-groups>`],[AA,()=>j`<mxmp-grouping
                        .store=${this.store}
                        @active-player=${this.activePlayerListener}
                      ></mxmp-grouping>`],[sA,()=>j`
                      <mxmp-media-browser
                      ...
                      ></mxmp-media-browser>
                    `],[oA,()=>j` <mxmp-volumes .store=${this.store}></mxmp-volumes>`]]):j`<div class="no-players">No supported players found</div>`}
        </div>
        ${tA(A,(()=>j`<mxmp-footer
    ...
    `}}e([ae({attribute:!1})],nA.prototype,"hass",void 0),e([ae({attribute:!1})],nA.prototype,"config",void 0),e([le()],nA.prototype,"section",void 0),e([le()],nA.prototype,"store",void 0),e([le()],nA.prototype,"showLoader",void 0),e([le()],nA.prototype,"loaderTimestamp",void 0),e([le()],nA.prototype,"cancelLoader",void 0),e([le()],nA.prototype,"activePlayerId",void 0);class aA extends se{render(){const e=!!this.icon&&!!this.name||W;return j`
    ...
    `}}e([ae({attribute:!1})],dA.prototype,"store",void 0),e([ae({attribute:!1})],dA.prototype,"player",void 0),e([ae({type:Boolean})],dA.prototype,"selected",void 0),customElements.define("mxmp-group",dA);class hA extends se{render(){return this.activePlayer=this.store.activePlayer,this.groups=this.store.allGroups,j`
    ...
    `}static get styles(){return Ye}}e([ae({attribute:!1})],hA.prototype,"store",void 0);class gA extends se{render(){return this.config=this.store.config,j`
    ...
    `}static get styles(){return[o`
      ...
      `,Fe,Ye]}}e([ae({attribute:!1})],gA.prototype,"store",void 0),e([ae({type:Array})],gA.prototype,"items",void 0),customElements.define("mxmp-media-browser-list",gA);class EA extends se{render(){return this.config=this.store.config,j`
      <div class="icons">
        ${vt(this.items,this.config).map((e=>j`
            <ha-control-button
    ...
    `}buttonStyle(e){const t=`calc(100% / ${e} - 1% * 2)`;return lt({width:t,height:t,margin:"1%"})}static get styles(){return[Fe,o`
      ...
      `]}}e([ae({attribute:!1})],EA.prototype,"store",void 0),e([ae({attribute:!1})],EA.prototype,"items",void 0),customElements.define("mxmp-media-browser-icons",EA);class BA extends se{render(){var e;return j`
    ...
    `}}e([ae({attribute:!1})],BA.prototype,"store",void 0),customElements.define("mxmp-media-browser-header",BA);class uA extends se{constructor(){super(...arguments),this.onMediaItemSelected=e=>{const t=e.detail;this.playItem(t),this.dispatchEvent(tt(Je,t))}}render(){return this.config=this.store.config,this.activePlayer=this.store.activePlayer,this.mediaBrowseService=this.store.mediaBrowseService,this.mediaControlService=this.store.mediaControlService,j`
    ...
    `}}e([ae({attribute:!1})],mA.prototype,"store",void 0),e([le()],mA.prototype,"showSwitches",void 0),customElements.define("mxmp-volumes",mA);class pA extends se{render(){const e=this.store.hass.states[this.store.activePlayer.id];let t=0;this.features.forEach((e=>t+=e));const A=Object.assign(Object.assign({},e),{attributes:Object.assign(Object.assign({},e.attributes),{supported_features:t})});return j` <more-info-content .stateObj=${A} .hass=${this.store.hass}></more-info-content> `}}e([ae({attribute:!1})],pA.prototype,"store",void 0),e([ae({attribute:!1})],pA.prototype,"features",void 0),customElements.define("mxmp-ha-player",pA),window.customCards.push({type:"maxi-media-player",name:"Maxi Media Player",description:"Media card for Home Assistant UI with a focus on managing multiple media players",preview:!0}),customElements.define("maxi-media-player",nA),customElements.define("mxmp-grouping",cA),customElements.define("mxmp-groups",hA),customElements.define("mxmp-media-browser",uA),customElements.define("mxmp-player",gt);
