...
I=0;function y(){if(I<10)try{A=document.querySelector("home-assistant"),x=A.shadowRoot.querySelector("home-assistant-main").shadowRoot,
u=x.querySelector("partial-panel-resolver"),E=x.querySelector("ha-panel-lovelace"),M=E.shadowRoot.querySelector("hui-root"),
D=M.shadowRoot.querySelector("ha-app-layout")}catch(t){I++,setTimeout(function(){return y()},50)}else E&&!M?console.log("hui-root not found."
):E&&!D&&console.log("ha-app-layout not found.")}var R=["APP-HEADER","HA-SLIDER","SWIPE-CARD","HUI-MAP-CARD","ROUND-SLIDER","XIAOMI-VACUUM-MAP-CARD",
"HA-SIDEBAR"];function f(){var o,r,a,t,e,i,l,n,s,c,u,y,f,d,p,h,v,b,m;function w(t){var e,n;0==h&&!l&&m||h==a.length-1&&!l&&!m||("swipe"==i?(e=(
...
E=x.querySelector("ha-panel-lovelace"),M=E.shadowRoot.querySelector("hui-root"),E&&M&&(I=0,o=(D=M.shadowRoot.querySelector("ha-app-layout")
).querySelector('[id="view"]'),r=D.querySelector("paper-tabs")||D.querySelector("ha-tabs"),a=r?Array.from(r.querySelectorAll("paper-tab")):[],
...
function(t){if("object"==g(t.path)){var e=S(t.path);try{for(e.s();!(n=e.n()).done;){var n=n.value;if("HUI-VIEW"==n.nodeName)break;if(-1<R.indexOf(
...
):d<-Math.abs(screen.width*s)&&(m=!0,w(0==h?b:h-1));t&&(m=!m);y=f=d=p=null},{passive:!0}),"swipe"==i&&(D.style.overflow="hidden")))}function d(t){
var e,n=S(t);try{for(n.s();!(e=n.n()).done;){var o=S(e.value.addedNodes);try{for(o.s();!(r=o.n()).done;){var r=r.value;if(
"ha-panel-lovelace"==r.localName)return void new MutationObserver(p).observe(r.shadowRoot,{childList:!0})}}catch(t){o.e(t)}finally{o.f()}}}catch(t){
n.e(t)}finally{n.f()}}function p(t){var e,n=S(t);try{for(n.s();!(e=n.n()).done;){var o=S(e.value.addedNodes);try{for(o.s();!(r=o.n()).done;){
var r=r.value;if("hui-root"==r.localName)return void new MutationObserver(h).observe(r.shadowRoot,{childList:!0})}}catch(t){o.e(t)}finally{o.f()}}
}catch(t){n.e(t)}finally{n.f()}}function h(t){var e,n=S(t);try{for(n.s();!(e=n.n()).done;){var o,r=S(e.value.addedNodes);try{for(r.s();!(o=r.n()
).done;)if("ha-app-layout"==o.value.localName)return void f()}catch(t){r.e(t)}finally{r.f()}}}catch(t){n.e(t)}finally{n.f()}}y(),f(),
new MutationObserver(d).observe(u,{childList:!0});for(var v={header:"%c≡ swipe-navigation".padEnd(27),ver:"%cversion 1.3.1 "},b="%c\n",
m=Math.max.apply(Math,e(Object.values(v).map(function(t){return t.length}))),w=0,O=Object.entries(v);w<O.length;w++){var q=t(O[w],1),k=q[0]
;v[k].length<=m&&(v[k]=v[k].padEnd(m)),"header"==k&&(v[k]="".concat(v[k].slice(0,-1),"⋮ "))}
...
,T="border-width:0px 1px 1px 1px;padding:7px;background:white;color:#424242;line-height:0.7;";console.info(v.header+b+v.ver,j,"","".concat(j," "
).concat(T));